...
[![Native SDK 3.0.4](https://img.shields.io/badge/native%20SDK-3.0.4-blue)](../../releases/tag/v3.0.4)
...
| Item | Requirement |
| --- | --- |
| Native SDK version | `3.0.4` |
| CocoaPod version | `3.0.4` |
...
`3.0.4` resolves the verified native SDK `v3.0.4` framework release.
